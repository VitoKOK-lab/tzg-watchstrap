...
export const designs: Design[] = [
  ...
  { id:'geometric',number:'02',model:'G852-5',name:'幾何輪廓',image:'/images/geometric-shadowless.webp',sampleVideo:{src:'/videos/geometric-sample.mp4',poster:'/images/geometric-sample-poster.jpg',label:'幾何輪廓 · 樣品實拍'},description:'以幾何造型與鏈節，勾勒富有層次的腕間輪廓。',options:[{id:'18k',label:'18K 材質',shell:660000,band:1330000,total:1990000},{id:'925',label:'925 無鑽',shell:28000,band:88000,total:116000}] },
