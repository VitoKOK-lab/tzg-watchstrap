...
export type Design = { id: string; number: string; model: string; name: string; image: string; lifestyleImage?: string; colorImages?: Record<string,string>; colorVideos?: Record<string,{src:string;poster:string}>; description: string; options: PriceOption[] };
export const designs: Design[] = [
  { id: 'circle', number:'01',model:'G852', name:'圓環鏈節', image:'/images/circle-white.webp', description:'圓環彼此相扣，讓俐落線條隨手腕自然延伸。', options:[{id:'18k',label:'18K 材質',shell:660000,band:890000,total:1550000},{id:'925',label:'925 無鑽',shell:28000,band:55000,total:83000},{id:'925-case',label:'925 滿鑽錶殼（單品）',shell:89000,band:null,total:null}] },
  { id:'geometric',number:'02',model:'G852-5',name:'幾何輪廓',image:'/images/geometric-white.webp',description:'以幾何造型與鏈節，勾勒富有層次的腕間輪廓。',options:[{id:'18k',label:'18K 材質',shell:660000,band:1330000,total:1990000},{id:'925',label:'925 無鑽',shell:28000,band:88000,total:116000}] },
  { id:'pave',number:'03',model:'G852-5',name:'幾何光影',image:'/images/pave-white.webp',description:'在幾何線條之間融入鑲嵌細節，呈現細膩光影。',options:[{id:'18k-diamond',label:'18K 真鑽',shell:1300000,band:2300000,total:3600000},{id:'18k-lab',label:'18K 培育',shell:1100000,band:2000000,total:3100000},{id:'18k-moissanite',label:'18K 莫桑',shell:900000,band:1800000,total:2700000},{id:'925',label:'925 滿鑽',shell:150000,band:200000,total:350000}] },
  { id:'green',number:'04',model:'G852-7',name:'綠境星河',image:'/images/green-white.webp',colorImages:{white:'/images/green-white.webp',yellow:'/images/green-yellow.webp',rose:'/images/green-rose.webp',black:'/images/green-black.webp'},colorVideos:{white:{src:'/videos/green-white.mp4',poster:'/images/green-white-video-poster.jpg'}},description:'深綠長方石與細緻光芒並列，像一段落在腕間的星河。',options:[{id:'18k-diamond',label:'18K 真鑽',shell:1300000,band:3200000,total:4500000},{id:'18k-lab',label:'18K 培育',shell:1100000,band:2700000,total:3800000},{id:'18k-moissanite',label:'18K 莫桑',shell:900000,band:2300000,total:3200000},{id:'925',label:'925 滿鑽',shell:150000,band:300000,total:450000}] },
  { id:'coloured',number:'05',model:'G852-6',name:'多彩序曲',image:'/images/coloured-white.webp',description:'不同色彩與造型相互交織，展現豐富的視覺層次。',options:[{id:'18k-diamond',label:'18K 真鑽',shell:1300000,band:5200000,total:6500000},{id:'18k-lab',label:'18K 培育',shell:1100000,band:3100000,total:4200000},{id:'18k-moissanite',label:'18K 莫桑',shell:900000,band:2900000,total:3800000},{id:'925',label:'925 滿鑽',shell:150000,band:300000,total:450000}] },
];
export const colors = [
